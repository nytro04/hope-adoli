    ...
    <div class="flex justify-between">
      ...
      <div class="w-6/12">
        ...
        <p class="text-gray-400">
          Wacommunicate is one of the flagship products of Ghanaian startup
          Walulel. It is a Geo-social management app. With over t connects
          property owners and tenants.
        </p>

        <div class="mt-20">
          <a
            class="shadow-md btn btn__white"
            href="https:wacomm"
            target="_blank"
          ...
          <a
            class="ml-5 shadow-md btn btn__white"
            href="https:wacomm"
            target="_blank"
            rel="noopener noreferrer"
          >
